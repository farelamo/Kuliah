...
<html>
  ...
  <section class="content">
    <div class="card">
      ...
      <div class="card-body">
        <div class="col-md-12">
          <form method="post" action="index.php?include=kategoribuku">
            <div class="row">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?= $kategori_buku; ?></td>
                <td align="center">
                  <a href="index.php?include=editkategoribuku&data=<?= $id_kategori_buku; ?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
                  <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?= $kategori_buku; ?>?'))window.location.href =
                       'index.php?include=kategoribuku&aksi=hapus&data=<?=$id_kategori_buku; ?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i>
                    Hapus</a>
                </td>
              </tr>
            <?php $no++;
      ...
      <ul class="pagination pagination-sm m-0 float-right">
        ...
        if ($jum_halaman == 0) {
          ...
          if ($halaman != 1) {
            ...
            <a class='page-link'href='index.php?include=kategoribuku&halaman=1'>First</a></li>";
            echo "<li class='page-item'>
            <a class='page-link'href='index.php?include=kategoribuku&halaman=$sebelum'>«</a></li>";
          }
          for ($i = 1; $i <= $jum_halaman; $i++) {
            if ($i > $halaman - 5 and $i < $halaman + 5) {
              if ($i != $halaman) {
                echo "<li class='page-item'>
                <a class='page-link'href='index.php?include=kategoribuku&halaman=$i'>$i</a></li>";
              } else {
          ...
          if ($halaman != $jum_halaman) {
            echo "<li class='page-item'>
            <a class='page-link'href='index.php?include=kategoribuku&halaman=$setelah'>»</a></li>";
            echo "<li class='page-item'>
            <a class='page-link'href='index.php?include=kategoribuku&halaman=$jum_halaman'>Last</a></li>";
          }
        } ?>
      </ul>
      </div>
