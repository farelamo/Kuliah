...
if(isset($_SESSION['id_kategori_buku'])){
 ...
 if(empty($kategori_buku)){
	header("Location:index.php?include=editkategoribuku&data=".$id_kategori_buku."&notif=editkosong");
	 }else{
	...
	header("Location:index.php?include=kategoribuku&notif=editberhasil");
	 }
}
?>