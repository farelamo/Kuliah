...
<html>
    ...
    <div class="card card-info">
      ...
      <?php if((isset($_GET['notif']))){?>
       ...
       <?php }?>
       <?php }?>
      <form action="index.php?include=konfirmasitambahuser" method="post" class="form-horizontal" 
        ...
        <div class="card-footer">
          <div class="col-sm-12">
            <button name="tambah" type="submit" class="btn btn-info float-right"><i class="fas fa-plus"></i> Tambah</button>
          </div>  
        </div>
        <!-- /.card-footer -->
      </form>
