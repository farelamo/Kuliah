    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="index.php?include=kategoriblog" class="btn btn-sm btn-warning float-right">
      ...
      <form class="form-horizontal" method="post"
         action="index.php?include=konfirmasitambahkategoriblog">
        <div class="card-body">
          <div class="form-group row">
            <label for="kategoribuku" class="col-sm-3 col-form-label">Kategori Blog</label>
            <div class="col-sm-7">
              <input name="kategori_blog" type="text" class="form-control" id="kategoriblog" value="">
            </div>
          </div>
        </div>
        <!-- /.card-body -->
