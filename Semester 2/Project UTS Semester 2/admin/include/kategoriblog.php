  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="card-tools">
        <a href="index.php?include=tambahkategoriblog" class="btn btn-sm btn-info float-right">
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td><?= $kategori_blog; ?></td>
              <td align="center">
                <a href="index.php?include=editkategoriblog&data=<?= $id_kategori_blog; ?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
                <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?= $kategori_blog; ?>?'))window.location.href =
                  'index.php?include=kategoriblog&aksi=hapus&data=<?= $id_kategori_blog; ?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i>
                  Hapus</a>
              </td>
            </tr>
          <?php $no++;
      ...
      <ul class="pagination pagination-sm m-0 float-right">
        ...
        if ($jum_halaman == 0) {
          ...
          if ($halaman != 1) {
            ...
            <a class='page-link'href='index.php?include=kategoriblog&halaman=1'>First</a></li>";
            echo "<li class='page-item'>
            <a class='page-link'href='index.php?include=kategoriblog&halaman=$sebelum'>«</a></li>";
          }
          for ($i = 1; $i <= $jum_halaman; $i++) {
            if ($i > $halaman - 5 and $i < $halaman + 5) {
              if ($i != $halaman) {
                echo "<li class='page-item'>
                <a class='page-link'href='index.php?include=kategoriblog&halaman=$i'>$i</a></li>";
              } else {
          ...
          if ($halaman != $jum_halaman) {
            echo "<li class='page-item'>
            <a class='page-link'href='index.php?include=kategoriblog&halaman=$setelah'>»</a></li>";
            echo "<li class='page-item'>
            <a class='page-link'href='index.php?include=kategoriblog&halaman=$jum_halaman'>Last</a></li>";
          }
        } ?>
      </ul>
    </div>
