...
header("Location:index.php?include=tambahbuku&notif=tambahkosong&jenis=kategori buku");
}else if(empty($judul)){
...
header("Location:index.php?include=tambahbuku&notif=tambahkosong&jenis=tahun terbit");
}else if(empty($tag)){
