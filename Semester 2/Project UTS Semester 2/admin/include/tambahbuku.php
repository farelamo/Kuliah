...
<html>
      ...
      <section class="content">
        ...
        <div class="card card-info">
          ...
          <form class="form-horizontal" action="index.php?include=konfirmasitambahbuku" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  ...
                  while ($data_g = mysqli_fetch_row($query_g)) {
                    ...
                    $tg = $data_g[1];
                  ?>
                    <input type="checkbox" name="tag[]" value="<?= $id_tg; ?>">
                    <?= $tg; ?> </br>
                  <?php } ?>
                </div>
              </div>
